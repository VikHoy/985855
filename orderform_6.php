...
$services -> Setnazvanie('Лабораторные работы по курсу Разработка интернет приложений в сфере коммерциии посредством PHP и MySQL <br> Студента группы ПИс-161: Перфильев В.Ю. <br> Проверил: к.т.н. доц. Назимов А.С.');
